...
qualifier_pattern:
	...
	| REACH LPAREN qual_expr COMMA qual_expr RPAREN
			{ mkpredpat (Ppredpat_reach($3, $5)) }
	| LINK LPAREN qual_term COMMA qual_litident COMMA INT COMMA qual_term COMMA qual_term RPAREN 
	    { mkpredpat (Ppredpat_link($3, Longident.parse $5, $7, $9, $11))}
	| FORALL LPAREN qual_term_list RPAREN DOT qualifier_pattern
	    { mkpredpat (Ppredpat_forall($3, $6)) }                 
