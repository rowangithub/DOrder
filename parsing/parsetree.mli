...
and predpat_desc =
  ...
  | Ppredpat_or of predicate_pattern * predicate_pattern
	| Ppredpat_reach of predpatexp * predpatexp
	| Ppredpat_link of predpatexp * Longident.t * int * predpatexp * predpatexp
	| Ppredpat_forall of predpatexp list * predicate_pattern
