...
class printer :
  string -> Env.t -> Frame.t Lightenv.t -> (Location.t -> Frame.t) -> 
		Backwalker.function_env -> (Path.t, Types.type_declaration) Hashtbl.t ->
  object ('b)
    val pipe : bool
    val semi : bool
    method binding :
    ...
    method class_params_def :
      Format.formatter -> (string * (bool * bool)) list -> unit
    ...
    method type_param :
      Format.formatter -> (bool * bool) * string -> unit
